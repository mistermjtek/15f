        ...
        <div className='faqs'>
          ...
          <ul className='faq'>
            <li className='qa'>
              ...
              <p>Anything really. The project is up to you and your team. You have 24 hours to make anything, ranging from web apps, desktop apps, mobile apps, or even traditional software.</p>
            </li>
            <li className='qa'>
