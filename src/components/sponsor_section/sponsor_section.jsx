  ...
  render: function() {
    ...
    return (
      <section className='SponsorSection page-section' id='sponsor'>
        ...
        <h5 className='subtitle'>A huge thanks to all our amazing DubHacks sponsors! Interested in sponsoring?<br/>Check out our <a href='/sponsor.pdf' className='sponsor-cta'>sponsor document</a> or email us at <a href='mailto:sponsor@dubhacks.co' className='sponsor-cta'>sponsor@dubhacks.co</a>.</h5>
        <div className='tiers'>
