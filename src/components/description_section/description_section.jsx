    ...
    return (
      <section className='DescriptionSection page-section'>
        <div className='text'>
          ...
          <p className='description'>This spring, join 200 other college hackers at Mary Gates Hall to build the next generation of innovative software and hardware hacks. This time, we're featuring a <strong>50-50 female/male ratio</strong> and focusing on bringing mentorship and resources to new developers, designers, and makers.</p>
        </div>
